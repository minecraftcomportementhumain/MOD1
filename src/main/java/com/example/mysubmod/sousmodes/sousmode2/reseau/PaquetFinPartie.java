...
public class PaquetFinPartie {
    ...
    public static class GestionnairePaquetsClient {
        public static void gererFinPartie() {
            com.example.mysubmod.sousmodes.sousmode2.client.MinuterieJeuClient.marquerPartieTerminee();
            ...
            // Désactiver le HUD du minuterie de pénalité
            com.example.mysubmod.sousmodes.sousmode2.client.HUDMinuteriePenalite.desactiver();
            // Désactiver le HUD du compteur de bonbons (cela efface aussi la spécialisation)
