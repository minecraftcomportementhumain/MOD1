 ...
 * où type = A ou B
 */
public class SubMode2SpawnFileManager extends SpawnFileManager {
    private final String CANDY_SPAWN_DIRECTORY = "candy_spawn_configs_submode2";

    public SubMode2SpawnFileManager() {
        super();
    }
    ...
    @Override
    public List<SubMode2SpawnEntry> loadSpawnConfig(String filePathOrName) {
        List<SubMode2SpawnEntry> entries = new ArrayList<>();
        ...
        try (BufferedReader reader = Files.newBufferedReader(configFile)) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                try {
                    SubMode2SpawnEntry entry = parseLine(trimmedLine);
                    if (entry != null) {
                        entries.add(entry);
                        modifiedLines.add(line);
                    }
    ...
    @Override
    protected SubMode2SpawnEntry parseLine(String line) {
        ...
        return new SubMode2SpawnEntry(timeSeconds, candyCount, position, type);
    }
