...
public class SpawnFileManager {
    ...
    private static SpawnFileManager instance;

    public SpawnFileManager() {
    }

    public static SpawnFileManager getInstance() {
        if (instance == null) {
            instance = new SpawnFileManager();
        }
        return instance;
    }
    ...
    public List<? extends CandySpawnEntry> loadSpawnConfig(String filePathOrName) {
    ...
    protected CandySpawnEntry parseLine(String line) {
     ...
     */
    protected boolean isPositionOnIsland(net.minecraft.core.BlockPos pos) {
